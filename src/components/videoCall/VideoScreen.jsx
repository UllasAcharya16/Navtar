...
function VideoScreen() {
  ...
  const APP_ID = 'a7aeacef31f4472ab9e1545f3622309a'; // Replace with your Agora App ID
  const TOKEN = '007eJxTYNDTC5TpW79h1VK58HmTagw1/F/MNaxxSrzydS7Pg+ZdDqIKDInmiamJyalpxoZpJibmRolJlqmGpiamacZmRkbGBpaJv3/7ZDQEMjLcdqpkYmSAQBBfkKEsMyU13zk/r7g0pySxJDM/j4EBANwUJMU='; // Replace with your temp token if required
